// functions/api/admin/sync-boardgames-from-sheet.js
...
export async function onRequest(context) {
    ...
    try {
        ...
        console.error(`Error in sync-boardgames-from-sheet API:`, error);
        return new Response(JSON.stringify({ error: '同步桌遊失敗。', details: error.message }), {
            status: 500,
            headers: { 'Content-Type': 'application/json' },
        });
    }
