...
<div class="details-tab-content active" id="tab-adventurer" style="padding: 8px 5px; line-height: 1.3;">
    
    <div style="margin-bottom: 3px; font-size: 0.95rem;">
        <span style="display: inline-block; width: 45%;">等級: ${profile.level} (${profile.current_exp}/10 EXP)</span>
        <span style="display: inline-block; width: 45%;">職業: ${profile.class}</span>
    </div>

    <div style="margin-bottom: 3px;">
        稱號: 
        <span style="display: inline-flex; flex-wrap: wrap; gap: 2px;">
            ${renderAssetsHtml('title')}
        </span>
    </div>
